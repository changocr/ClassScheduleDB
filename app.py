...
/* ========== 核心：学生课表零行距样式 ========== */
.student-schedule-wrapper [data-testid="stHorizontalBlock"] {
...
/* 强制消除行内所有元素的垂直边距 */
.student-schedule-wrapper [data-testid="column"] > div {
    margin-top: 0 !important;
    margin-bottom: 0 !important;
    padding-top: 0 !important;
    padding-bottom: 0 !important;
...
if user_name.lower() == "admin":
    ...
    # 课表专属容器，所有零行距样式限定在这里
    with st.container():
        st.markdown('<div class="student-schedule-wrapper">', unsafe_allow_html=True)
