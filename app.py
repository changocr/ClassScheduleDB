...
if user_name.lower() == "admin":
    ...
    .stButton > button {
        width: 100% !important;
        flex: 1 1 auto !important; /* 强制填充满 stButton 包装器 */
        height: 48px !important; /* 进一步增加行高以适应现代 UI */
        border-radius: 0 !important;
        border: 1px solid #eaebec !important; /* 更浅的边框色 */
    ...
    .schedule-header, .schedule-time {
        ...
        background-color: transparent !important; /* 修复底色色差 */
    }
    .schedule-time {
